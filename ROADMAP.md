...
## v0.2
- [ ] More platform playbooks — Windows Server was added after v0.1; candidates: Kubernetes/container platforms, network devices, hypervisors, Microsoft 365 / Entra ID tenants, and a general cloud-workload playbook
- [ ] Scenario playbooks
...
## Later
- [ ] AI/agent platform profile — detection and response for AI agents, MCP servers and agent skills, once the standards settle. Tracking the OWASP Agentic Skills Top 10 (incubator stage, v1.0 in public review as of 2026) — not yet stable enough to build normative guidance on.
