...
- [`playbooks/`](playbooks/) — IR + digital forensics playbooks for Windows 11 laptops, macOS laptops, Windows Server (including domain controllers) and Linux (RHEL-class) servers, plus Microsoft/CISA baseline references.
